...
class AppTextStyles {
  ...
  static final TextStyle heading32 = GoogleFonts.notoSans(
    color: AppColors.black,
    fontSize: 32,
    fontWeight: FontWeight.w600,
  );
  ...
  static final TextStyle textTituloQuestion = GoogleFonts.notoSans(
  ...
  static final TextStyle bodyBold = GoogleFonts.notoSans(
    ...
    static final TextStyle bodyBlackBold = GoogleFonts.notoSans(
